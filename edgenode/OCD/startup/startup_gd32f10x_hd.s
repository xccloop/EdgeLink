@ Startup file for GD32F103 High-Density devices (RCT6)
@ Cortex-M3, 256KB Flash, 48KB SRAM
@ GNU assembler syntax, vector table matches the official GD32F10x V2.7.0 HD layout.
...
Reset_Handler:
                ...
                @ Configure the system clock (PLL) and set SystemCoreClock
                bl      SystemInit
...
Default_Handler:
                ...
                @ Weak aliases: every unused IRQ falls through to Default_Handler
                .weak   NMI_Handler
